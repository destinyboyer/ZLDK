...
class DVDFactory {
	...
	/*------------------------------------------------------------------------------------------------
		...
		Method takes in a file stream and a vector of set pointers. The method creates DVD
		objects based on the type of DVD read from the file stream and then inserts the object
		into a set that corresponds with that DVD type.
	...
	void createTransactions(ifstream& inFile, vector<set<DVD>*> inventory);
